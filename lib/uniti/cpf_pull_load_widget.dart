...
///通用下上刷新控件
class CPFPullLoadWidget extends StatefulWidget {
  ///item渲染
  ...
  CPFPullLoadWidget(this.control, this.itemBuilder, this.onRefresh, this.onLoadMore, {this.refreshKey});

  @override
  _CPFPullLoadWidgetState createState() => _CPFPullLoadWidgetState();
}

class _CPFPullLoadWidgetState extends State<CPFPullLoadWidget> {
    ...
    return new Container(
      ...
      child: new Column(
        ...
        children: <Widget>[
          FlatButton(
            onPressed: () {},
            child: new Image(image: new AssetImage('images/我的@2x.png'), width: 70.0, height: 70.0),
          ),
          Container(
            child: Text('暂无数据', style: TextStyle(fontSize: 18.0,color: Colors.grey)),
          ),
        ],
      ),
    );
